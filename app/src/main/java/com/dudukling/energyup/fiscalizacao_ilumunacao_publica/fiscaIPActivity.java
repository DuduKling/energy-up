...
import com.dudukling.energyup.adapter.fiscaIP_recyclerAdapter;
...
//                uploadToCloud();
    ...
    private void exportFiscalizacoes(String type, SQLiteDatabase db) {
        ...
        if (type.equals("backup")) {
            file = new File(exportDir, "EnergyBackupFiscalizacaoIluminacaoPublica_" + timeStamp + ".csv");
        } else {
            file = new File(exportDir, "EnergyExportFiscalizacaoIluminacaoPublica_" + timeStamp + ".csv");
        }
