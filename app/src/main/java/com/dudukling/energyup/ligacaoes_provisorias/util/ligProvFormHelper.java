...
//                intent.setData(Uri.parse("mailto:")); // only email apps should handle this
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"email@mail.com","email222@gmail.com"});
                intent.putExtra(Intent.EXTRA_SUBJECT, "Ligação Provisória (Fiscalização Gestor Energy) – Nº OS: "+lp.getOrdem());
                intent.putExtra(Intent.EXTRA_TEXT,
                        "Segue abaixo as informações da fiscalização executadas no aplicativo Energy Up:\n\n" +
