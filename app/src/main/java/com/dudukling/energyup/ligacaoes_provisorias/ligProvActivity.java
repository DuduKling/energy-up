...
import com.dudukling.energyup.adapter.ligProv_recyclerAdapter;
...
//            exportImages();
    ...
    private void exportLPs(String type, SQLiteDatabase db) {
        ...
        if (type.equals("backup")) {
            file = new File(exportDir, "EnergyBackupLP_" + timeStamp + ".csv");
        } else {
            file = new File(exportDir, "EnergyExportLP_" + timeStamp + ".csv");
        }
