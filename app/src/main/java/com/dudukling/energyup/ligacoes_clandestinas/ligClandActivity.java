package com.dudukling.energyup.ligacoes_clandestinas;
...
//            exportImages();
    ...
    private void exportClandests(String type, SQLiteDatabase db) {
        ...
        if (type.equals("backup")) {
            file = new File(exportDir, "EnergyBackupClandestinos_" + timeStamp + ".csv");
        } else {
            file = new File(exportDir, "EnergyExportClandestinos_" + timeStamp + ".csv");
        }
